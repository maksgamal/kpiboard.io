!(function () {
  try {
    ...
    n &&
      ...
      (e._sentryDebugIds[n] = "9c90381e-4c09-55f7-8ccd-e8514f0fa4f7"));
  } catch (e) {}
})();
!(function () {
  "use strict";
  ...
  var i,
              ...
              "script" === e.initiatorType && s
                ...
                : "xmlhttprequest" === e.initiatorType &&
                  ...
                  a.push({
                    ...
                    startTime: e.fetchStart,
                    duration: e.responseEnd - e.fetchStart,
                    detail: { name: e.name, responseStatus: e.responseStatus },
                  }));
            }
            a.length &&
              ((o.measures = [].concat(
              ...
              i &&
                o.subscription.has(i) &&
                (null === (u = o.subscription.get(i)) ||
                  void 0 === u ||
                  u(a, e)));
          });
        });
    ...
    c = function (e) {
      e.forEach(function (e) {
        ...
        null != n && n.includes("hotjar")
          ? (r = "hotjar-js")
          : null != n && n.includes("modules") && (r = "modules-js"),
          r &&
            o &&
            e.startTime > 0 &&
  ...
  !(function () {
    try {
      !(function () {
        ...
        var e = function () {
          i.subscribe("resource_timing", c),
            i.subscribe("request_latency", l),
            i.subscribe("request_error", f),
            i.start(["resource"]);
        };
