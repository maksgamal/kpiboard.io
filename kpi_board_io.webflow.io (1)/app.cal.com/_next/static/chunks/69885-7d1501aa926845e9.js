    ...
    69885: (t, e, a) => {
      ...
      var b = (t) => {
        ...
        let {
          ...
          tx = o.useMemo(
            () => B.findIndex((t) => t.toastId === E.id) || 0,
            [B, E.id]
          ),
          tE = o.useMemo(() => {
            var t;
          ...
          tk = o.useMemo(() => E.duration || L || 4e3, [E.duration, L]),
          tN = o.useRef(0),
          tT = o.useRef(0),
          tS = o.useRef(0),
          tB = o.useRef(null),
          ...
          tI = E.invert || x,
          tY = "loading" === tv;
        (tT.current = o.useMemo(() => tx * O + tz, [tx, tz])),
          o.useEffect(() => {
            tm.current = tk;
          }, [tk]),
          o.useEffect(() => {
          ...
          }, [Q, E.title, E.description, T, E.id]);
              ...
              return (
                z || N || (X && tR)
                  ...
                  : tm.current !== 1 / 0 &&
                    ...
                    (t = setTimeout(() => {
                      var t;
                      null == (t = E.onAutoClose) || t.call(E, E), tj();
                    }, tm.current))),
                () => clearTimeout(t)
              );
          }, [z, N, E, tv, X, tR, tj]),
          ...
          o.createElement(
            "li",
            {
              ...
              className: v(
                A,
                ty,
                null == _ ? void 0 : _.toast,
                null == (e = null == E ? void 0 : E.classNames)
                  ? void 0
                  : e.toast,
                null == _ ? void 0 : _.default,
                null == _ ? void 0 : _[tv],
                null == (a = null == E ? void 0 : E.classNames) ? void 0 : a[tv]
              ),
              "data-sonner-toast": "",
              ...
              style: {
                ...
                "--toasts-before": C,
                "--z-index": M.length - C,
                "--offset": "".concat(tt ? tl : tT.current, "px"),
                "--initial-height": W ? "auto" : "".concat(tc, "px"),
                ...j,
                ...E.style,
              },
              onDragEnd: () => {
                to(!1), q(null), (tB.current = null);
              },
              onPointerDown: (t) => {
                tY ||
                  !tb ||
                  ...
                  "BUTTON" !== t.target.tagName &&
                    (to(!0), (tB.current = { x: t.clientX, y: t.clientY })));
              },
              onPointerUp: () => {
                var t, e, a, o;
                if (tr || !tb) return;
              ...
              onPointerMove: (e) => {
                ...
                if (
                  ...
                  return;
                let s = e.clientY - tB.current.y,
                  i = e.clientX - tB.current.x,
                  l =
                  ...
                  "button",
                  {
                    ...
                    onClick:
                      tY || !tb
                        ...
                        : () => {
                            var t;
                            tj(), null == (t = E.onDismiss) || t.call(E, E);
                          },
                    className: v(
                      null == _ ? void 0 : _.closeButton,
                      null == (n = null == E ? void 0 : E.classNames)
                        ? void 0
                        : n.closeButton
                    ),
                  },
                  null != (m = null == F ? void 0 : F.close) ? m : u
                )
              : null,
            E.jsx || (0, o.isValidElement)(E.title)
              ? E.jsx
                ? E.jsx
                    ...
                    ? o.createElement(
                        "div",
                        {
                          ...
                          className: v(
                            ...
                            null == (h = null == E ? void 0 : E.classNames)
                              ? void 0
                              : h.icon
                          ),
                        },
                    ...
                    o.createElement(
                      "div",
                      {
                        ...
                        className: v(
                          ...
                          null == (f = null == E ? void 0 : E.classNames)
                            ? void 0
                            : f.title
                        ),
                      },
                    ...
                    ? o.createElement(
                        "button",
                        {
                          ...
                          onClick: (t) => {
                            ...
                            g(E.cancel) &&
                              tb &&
                              (null == (a = (e = E.cancel).onClick) ||
                                a.call(e, t),
                              tj());
                          },
                          className: v(
                            null == _ ? void 0 : _.cancelButton,
                  ...
                  (0, o.isValidElement)(E.action)
                    ...
                    ? o.createElement(
                        "button",
                        {
                          "data-button": !0,
                          "data-action": !0,
                          style: E.actionButtonStyle || D,
                          onClick: (t) => {
                            var e, a;
                            g(E.action) &&
                              (null == (a = (e = E.action).onClick) ||
                                a.call(e, t),
                              t.defaultPrevented || tj());
                          },
                          className: v(
                            null == _ ? void 0 : _.actionButton,
                ...
                ? o.createElement(
                    "ol",
                    {
                      ...
                      onFocus: (t) => {
                        (t.target instanceof HTMLElement &&
                          ...
                          O.current ||
                          ((O.current = !0), (V.current = t.relatedTarget));
                      },
                      onMouseEnter: () => Y(!0),
                      onMouseMove: () => Y(!0),
                      onMouseLeave: () => {
                    ...
                    B.filter(
                      ...
                      return o.createElement(b, {
                        ...
                        defaultRichColors: p,
                        duration:
                          null != (s = null == w ? void 0 : w.duration) ? s : f,
...
//# sourceMappingURL=69885-7d1501aa926845e9.js.map
