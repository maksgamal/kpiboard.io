    ...
    28141: (e, t, r) => {
        ...
        let o = String(t),
          ...
          l = (e, t) =>
            null != t && "string" == typeof t
              ...
              ? t.reduce((e, t) => l(e, t), e)
              : null != t && null != t[e.trim()]
              ? l(e, t[e.trim()])
              : null != t && null != t["*"]
              ? l(e, t["*"])
              : e;
        return o.replace(/{{(.+?)}}/g, (t, n) => {
          let o = null != r[n] ? String(r[n]) : i ? "" : t;
          return e.stylePrettyLogs
            ? l(o, e?.prettyLogStyles?.[n] ?? null) + a("", s.reset)
            : o;
        });
      }
      ...
      function g(e, t) {
        ...
        return null != r &&
          a?.colors?.[r]?.[0] != null &&
          a?.colors?.[r]?.[1] != null
          ? "\x1b[" + a.colors[r][0] + "m" + e + "\x1b[" + a.colors[r][1] + "m"
          : e;
      }
      function h(e) {
      ...
      function m(e) {
        return f(e) && "[object RegExp]" === b(e);
      }
      function f(e) {
        return "object" == typeof e && null !== e;
      }
      function y(e) {
        return f(e) && ("[object Error]" === b(e) || e instanceof Error);
      }
      function d(e) {
        return f(e) && "[object Date]" === b(e);
      }
      function b(e) {
      ...
      function w(e, t, r = 0) {
        ...
        let f = "",
          ...
          P = ["{\n", "\n}"];
        if (
          (Array.isArray(t) && ((b = !0), (P = ["[\n", "\n]"])),
          h(t) && (f = " [Function" + (t.name ? ": " + t.name : "") + "]"),
          m(t) && (f = " " + RegExp.prototype.toString.call(t)),
          d(t) && (f = " " + Date.prototype.toUTCString.call(t)),
          y(t) && (f = " " + O(t)),
          ...
          (o = b
            ? (function (e, t, r, s, n) {
                ...
                for (let n = 0, o = t.length; n < o; ++n)
                  p(t, String(n))
                    ? i.push(L(e, t, r, s, String(n), !0))
                    : i.push("");
                return (
                  n.forEach((n) => {
                    n.match(/^\d+$/) || i.push(L(e, t, r, s, n, !0));
                  }),
                  i
                );
              })(e, t, r, g, u)
            : u.map((s) => L(e, t, r, g, s, b))),
          e.seen.pop(),
          (s = o),
          (n = f),
          (i = P)[0] +
      ...
      function L(e, t, r, s, n, i) {
        ...
        try {
          Object.getOwnPropertyDescriptor &&
            (u = Object.getOwnPropertyDescriptor(t, n) || u);
        } catch (e) {}
        if (
          (u.get
            ? (a = u.set
      ...
      let S = {
          getCallerStackFrame: k,
          getErrorTrace: E,
          getMeta: function (e, t, r, s, n, i) {
          ...
          transportFormatted: function (e, t, r, s) {
            let n = (r.length > 0 && t.length > 0 ? "\n" : "") + r.join("\n");
            (s.prettyInspectOptions.colors = s.stylePrettyLogs),
              console.log(
                e +
                  (function (e, ...t) {
                    let r = { seen: [], stylize: u };
                    ...
                    if ("string" == typeof s) {
                      ...
                      for (let l = 0; l < s.length - 1; l++)
                        if (37 === s.charCodeAt(l)) {
                          let h = s.charCodeAt(++l);
                          if (n + 1 !== t.length) {
                            switch (h) {
                              case 115: {
                                let s = t[++n];
                                u =
                                  "number" == typeof s || "bigint" == typeof s
                                    ? v(r, s)
                            ...
                            g !== l - 1 && (i += s.slice(g, l - 1)),
                              (i += u),
                              (g = l + 1);
                          } else
                            37 === h && ((i += s.slice(g, l)), (g = l + 1));
                        }
                      0 !== g &&
                        (n++, (l = " "), g < s.length && (i += s.slice(g)));
                    }
                    for (; n < t.length; ) {
                      let r = t[n];
                      (i += l),
                        (i += "string" != typeof r ? a(r, e) : r),
                        (l = " "),
                        n++;
                    }
                    return i;
                  })(s.prettyInspectOptions, ...t) +
                  n
              );
          },
          isBuffer: function (e) {
          ...
          prettyFormatLogObj: function (e, t) {
            return e.reduce(
              (e, r) => (A(r) ? e.errors.push(C(r, t)) : e.args.push(r), e),
              { args: [], errors: [] }
            );
          },
          prettyFormatErrorObj: C,
        },
        j = {
      ...
      function T(e) {
        ...
        if (null != e) {
          let s = e.match(N);
          if (s) {
            (r.filePath = s[1].replace(/\?.*$/, "")),
              (r.fullFilePath = `${t}${r.filePath}`);
      ...
      function C(e, t) {
        let r = E(e).map((e) => n(t, t.prettyErrorStackTemplate, { ...e }, !0)),
          s = {
            errorName: ` ${e.name} `,
        ...
        return n(t, t.prettyErrorTemplate, s);
      }
      class M {
        constructor(e, t, r = 4) {
          (this.logObj = t),
        ...
        log(e, t, ...r) {
          ...
          return (
            this.settings.overwrite?.formatMeta != null &&
              (s = this.settings.overwrite?.formatMeta(
                u?.[this.settings.metaProperty]
              )),
            this.settings.overwrite?.formatLogObj != null &&
              (n = this.settings.overwrite?.formatLogObj(o, this.settings)),
            "pretty" === this.settings.type &&
              ((s =
                s ??
                this._prettyFormatLogObjMeta(u?.[this.settings.metaProperty])),
              (n = n ?? this.runtime.prettyFormatLogObj(o, this.settings))),
            null != s && null != n
        ...
        _recursiveCloneAndMaskValuesOfKeys(e, t, r = []) {
          ...
          if (Array.isArray(e))
            return e.map((e) =>
              this._recursiveCloneAndMaskValuesOfKeys(e, t, r)
            );
          if (e instanceof Date) return new Date(e.getTime());
            ...
            let s = this.runtime.isError(e)
              ? this._cloneError(e)
              : Object.create(Object.getPrototypeOf(e));
            return Object.getOwnPropertyNames(e).reduce(
              (s, n) => (
                (s[n] = t.includes(
                  this.settings?.maskValuesOfKeysCaseInsensitive !== !0
                    ? n
                    : n.toLowerCase()
                )
                  ? this.settings.maskPlaceholder
                  : this._recursiveCloneAndMaskValuesOfKeys(e[n], t, r)),
                s
              ),
              s
            );
        ...
        _prettyFormatLogObjMeta(e) {
          ...
          t.includes("{{yyyy}}.{{mm}}.{{dd}} {{hh}}:{{MM}}:{{ss}}:{{ms}}")
            ...
            ? ((r.yyyy = e?.date?.getUTCFullYear() ?? "----"),
              (r.mm = i(e?.date?.getUTCMonth(), 2, 1)),
              (r.dd = i(e?.date?.getUTCDate(), 2)),
              (r.hh = i(e?.date?.getUTCHours(), 2)),
              (r.MM = i(e?.date?.getUTCMinutes(), 2)),
              (r.ss = i(e?.date?.getUTCSeconds(), 2)),
              (r.ms = i(e?.date?.getUTCMilliseconds(), 3)))
            : ((r.yyyy = e?.date?.getFullYear() ?? "----"),
              (r.mm = i(e?.date?.getMonth(), 2, 1)),
              (r.dd = i(e?.date?.getDate(), 2)),
              (r.hh = i(e?.date?.getHours(), 2)),
              (r.MM = i(e?.date?.getMinutes(), 2)),
              (r.ss = i(e?.date?.getSeconds(), 2)),
              (r.ms = i(e?.date?.getMilliseconds(), 3)));
          let s =
            "UTC" === this.settings.prettyLogTimeZone
              ? e?.date
              : new Date(
                  e?.date?.getTime() - e?.date?.getTimezoneOffset() * 6e4
                );
          (r.rawIsoStr = s?.toISOString()),
            (r.dateIsoStr = s
              ?.toISOString()
              .replace("T", " ")
              .replace("Z", "")),
            (r.logLevelName = e?.logLevelName),
            (r.fileNameWithLine = e?.path?.fileNameWithLine ?? ""),
            (r.filePathWithLine = e?.path?.filePathWithLine ?? ""),
            (r.fullFilePath = e?.path?.fullFilePath ?? "");
          let o = this.settings.parentNames?.join(
          ...
          return (
            (o =
              null != o && e?.name != null
                ...
                : void 0),
            (r.name =
              e?.name != null || null != o ? (o ?? "") + e?.name ?? "" : ""),
            (r.nameWithDelimiterPrefix =
              r.name.length > 0
                ? this.settings.prettyErrorLoggerNameDelimiter + r.name
                : ""),
            (r.nameWithDelimiterSuffix =
              r.name.length > 0
                ? r.name + this.settings.prettyErrorLoggerNameDelimiter
                : ""),
            this.settings.overwrite?.addPlaceholders != null &&
              this.settings.overwrite?.addPlaceholders(e, r),
            n(this.settings, t, r)
          );
        }
      }
      class x extends M {
        constructor(e, t) {
          ...
          ((e = e || {}).stylePrettyLogs =
            (!e.stylePrettyLogs || !r || !!s) && e.stylePrettyLogs),
            super(e, t, n ? 4 : 5);
        }
        log(e, t, ...r) {
