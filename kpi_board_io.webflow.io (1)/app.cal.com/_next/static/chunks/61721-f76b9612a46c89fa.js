  ...
  [61721],
  {
    ...
    52167: (e, t, i) => {
      ...
      function r() {
        if (console && console.warn) {
          for (var e, t = arguments.length, i = Array(t), n = 0; n < t; n++)
            i[n] = arguments[n];
          "string" == typeof i[0] && (i[0] = "react-i18next:: ".concat(i[0])),
            (e = console).warn.apply(e, i);
        }
      }
      i(5084), Object.create(null);
      var o = {};
      function a() {
      ...
      var g = i(28777),
        ...
        b = (function () {
          function e() {
            (0, m.A)(this, e), (this.usedNamespaces = {});
          }
          return (
            (0, y.A)(e, [
              {
      ...
      function w(e) {
        var t =
          ...
          l = r.defaultNS,
          g = i || o || n;
        if ((g && !g.reportNamespaces && (g.reportNamespaces = new b()), !g)) {
          a(
        ...
        var d = O(O(O({}, f), g.options.react), t),
          m = d.useSuspense,
          y = d.keyPrefix,
          k = e || l || (g.options && g.options.defaultNS);
        (k = "string" == typeof k ? [k] : k || ["translation"]),
          g.reportNamespaces.addUsedNamespaces &&
            g.reportNamespaces.addUsedNamespaces(k);
        var w =
        ...
        function N() {
          return g.getFixedT(
            t.lng || null,
            "fallback" === d.nsMode ? k : k[0],
            y
          );
        }
        var C = (0, s.useState)(N),
          R = (0, x.A)(C, 2),
          j = R[0],
          $ = R[1],
          P = k.join();
        t.lng && (P = "".concat(t.lng).concat(P));
        var E = L(P),
          A = (0, s.useRef)(!0);
        (0, s.useEffect)(
          function () {
        ...
        (0, s.useEffect)(
          function () {
            A.current && !I.current && $(N), (I.current = !1);
          },
          [g, y]
        );
        var F = [j, g, w];
        if (((F.t = j), (F.i18n = g), (F.ready = w), w || (!w && !m))) return F;
    ...
    94791: (e, t, i) => {
      ...
      function u(e, t, i) {
        ...
        return s() ? {} : { obj: e, k: n(r.shift()) };
      }
      function p(e, t, i) {
        let { obj: n, k: s } = u(e, t, Object);
        n[s] = i;
      }
      function g(e, t) {
        let { obj: i, k: n } = u(e, t);
      ...
      function m(e, t) {
        ...
        for (let e = 0; e < n.length; ++e) {
          if (!s || ("string" == typeof s[n[e]] && e + 1 < n.length)) return;
          if (void 0 === s[n[e]]) {
            let r = 2,
              o = n.slice(e, e + r).join(i),
              a = s[o];
            for (; void 0 === a && n.length > e + r; )
              r++, (a = s[(o = n.slice(e, e + r).join(i))]);
            if (void 0 === a) return;
      ...
      class v extends o {
        ...
        getResource(e, t, i) {
          let n =
            ...
            o = [e, t];
          i && "string" != typeof i && (o = o.concat(i)),
            i && "string" == typeof i && (o = o.concat(s ? i.split(s) : i)),
            e.indexOf(".") > -1 && (o = e.split("."));
          let a = g(this.data, o);
          return a || !r || "string" != typeof i
            ? a
            : m(this.data && this.data[e] && this.data[e][t], i, s);
        }
        addResource(e, t, i, n) {
          let s =
          ...
          i && (o = o.concat(r ? i.split(r) : i)),
            ...
            p(this.data, o, n),
            s.silent || this.emit("added", e, t, i, n);
        }
        addResources(e, t, i) {
          let n =
            arguments.length > 3 && void 0 !== arguments[3]
          ...
          for (let n in i)
            ("string" == typeof i[n] ||
              "[object Array]" === Object.prototype.toString.apply(i[n])) &&
              this.addResource(e, t, n, i[n], { silent: !0 });
          n.silent || this.emit("added", e, t, i);
        }
        addResourceBundle(e, t, i, n, s) {
          let r =
      ...
      var b = {
        ...
        handle(e, t, i, n, s) {
          return (
            e.forEach((e) => {
              this.processors[e] &&
                (t = this.processors[e].process(t, i, n, s));
            }),
            t
          );
        },
        ...
        extractFromKey(e, t) {
          ...
          let n =
            ...
            o =
              ...
              !(function (e, t, i) {
                (t = t || ""), (i = i || "");
                let n = f.filter((e) => 0 > t.indexOf(e) && 0 > i.indexOf(e));
          ...
          if (r && !o) {
            ...
            let r = e.split(i);
            (i !== n || (i === n && this.options.ns.indexOf(r[0]) > -1)) &&
              (s = r.shift()),
              (e = r.join(n));
          }
          ...
          if (
            ...
            if (!t.returnObjects && !this.options.returnObjects) {
              ...
              let e = this.options.returnedObjectHandler
                ? this.options.returnedObjectHandler(c, g, { ...t, ns: o })
                : `key '${r} (${this.language})' returned an object instead of string.`;
              return n ? ((p.res = e), p) : e;
            }
            if (s) {
              ...
              for (let e in g)
                if (Object.prototype.hasOwnProperty.call(g, e)) {
                  let r = `${n}${s}${e}`;
                  (i[e] = this.translate(r, { ...t, joinArrays: !1, ns: o })),
                    i[e] === r && (i[e] = g[e]);
                }
              g = i;
            }
          } else if (m && "string" == typeof f && "[object Array]" === d)
            (g = g.join(f)) && (g = this.extendTranslation(g, e, t, i));
          else {
            let n = !1,
              o = !1,
              ...
              f =
                ...
                t[`defaultValue${d}`] ||
                t.defaultValue;
            !this.isValidLookup(g) && c && ((n = !0), (g = f)),
              this.isValidLookup(g) || ((o = !0), (g = r));
            let m =
                ...
                o
                  ? void 0
                  : g,
              y = c && f !== g && this.options.updateMissing;
            if (o || n || y) {
              if (
                (this.logger.log(
              ...
              let n = (e, i, n) => {
                ...
                this.options.missingKeyHandler
                  ? this.options.missingKeyHandler(e, a, i, s, y, t)
                  : this.backendConnector &&
                    this.backendConnector.saveMissing &&
                    this.backendConnector.saveMissing(e, a, i, s, y, t),
                  this.emit("missingKey", e, a, i, g);
              };
              this.options.saveMissing &&
                (this.options.saveMissingPlurals && u
                  ? e.forEach((e) => {
                      this.pluralResolver.getSuffixes(e, t).forEach((i) => {
                        n([e], r + i, t[`defaultValue${i}`] || f);
                      });
                    })
                  : n(e, r, f));
            }
            (g = this.extendTranslation(g, e, t, p, i)),
              o &&
                g === r &&
                ...
                this.isValidLookup(t) ||
                  ...
                  h.forEach((i) => {
                    ...
                    if (this.i18nFormat && this.i18nFormat.addLookupKeys)
                      this.i18nFormat.addLookupKeys(a, l, i, e, o);
                    else {
                      let e;
                      p && (e = this.pluralResolver.getSuffix(i, o.count, o));
                    ...
                    for (; (r = a.pop()); )
                      this.isValidLookup(t) ||
                        ((n = r), (t = this.getResource(i, e, r, o)));
                  }));
              });
            }),
            { res: t, usedKey: i, exactUsedKey: n, usedLng: s, usedNS: r }
          );
        }
        isValidLookup(e) {
          return (
      ...
      class O {
        ...
        toResolveHierarchy(e, t) {
          ...
          return (
            ...
            i.forEach((e) => {
              0 > n.indexOf(e) && s(this.formatLanguageCode(e));
            }),
            n
          );
        }
      ...
      class j {
          ...
          (this.languageUtils = e),
            ...
            (this.rules = (function () {
              ...
              return (
                L.forEach((t) => {
                  t.lngs.forEach((i) => {
                    e[i] = { numbers: t.nr, plurals: w[t.fc] };
                  });
                }),
                e
              );
        ...
        getRule(e) {
          ...
          if (this.shouldUseIntlApi())
            try {
              return new Intl.PluralRules(y(e), {
      ...
      class P {
        ...
        resetRegExp() {
          ...
          let i = `${this.nestingPrefix}(.+?)${this.nestingSuffix}`;
          this.nestingRegexp = RegExp(i, "g");
        }
        interpolate(e, t, i, n) {
          let s,
            r,
          ...
          let p = (e) => {
            if (0 > e.indexOf(this.formatSeparator)) {
              ...
              return this.alwaysFormat
                ? this.format(s, void 0, i, { ...n, ...t, interpolationkey: e })
                : s;
            }
      ...
      function E(e) {
        ...
        return function (i, n, s) {
          let r = n + JSON.stringify(s),
            o = t[r];
          return o || ((o = e(n, s)), (t[r] = o)), o(i);
        };
      }
      class A {
        constructor() {
        ...
        format(e, t, i) {
          ...
          return t.split(this.formatSeparator).reduce((e, t) => {
            let { formatName: s, formatOptions: r } = (function (e) {
              ...
              if (e.indexOf("(") > -1) {
                ...
                "currency" === t && 0 > s.indexOf(":")
                  ? i.currency || (i.currency = s.trim())
                  : "relativetime" === t && 0 > s.indexOf(":")
                  ? i.range || (i.range = s.trim())
                  : s.split(";").forEach((e) => {
                      if (!e) return;
                      let [t, ...n] = e.split(":"),
                        s = n
                      ...
                      i[t.trim()] || (i[t.trim()] = s),
                        "false" === s && (i[t.trim()] = !1),
                        "true" === s && (i[t.trim()] = !0),
                        isNaN(s) || (i[t.trim()] = parseInt(s, 10));
                    });
              }
            ...
            if (this.formats[s]) {
              ...
              try {
                let o =
                    ...
                    {},
                  a = o.locale || o.lng || n.locale || n.lng || i;
                t = this.formats[s](e, a, { ...r, ...n, ...o });
              } catch (e) {
                this.logger.warn(e);
              }
              return t;
      ...
      class I extends o {
        ...
        loaded(e, t, i) {
          let n = e.split("|"),
            s = n[0],
            r = n[1];
          t && this.emit("failedLoading", s, r, t),
            i && this.store.addResourceBundle(s, r, i),
            (this.state[e] = t ? -1 : 2);
          let o = {};
          this.queue.forEach((i) => {
            !(function (e, t, i, n) {
              let { obj: s, k: r } = u(e, t, Object);
              (s[r] = s[r] || []), s[r].push(i);
            })(i.loaded, [s], r),
              void 0 !== i.pending[e] &&
        ...
        read(e, t, i) {
          ...
          let o = (o, a) => {
              ...
              if (o && a && n < this.maxRetries)
                return void setTimeout(() => {
                  this.read.call(this, e, t, i, n + 1, 2 * s, r);
                }, s);
              r(o, a);
            },
        ...
        loadOne(e) {
          let t =
            ...
            n = i[0],
            s = i[1];
          this.read(n, s, "read", void 0, void 0, (i, r) => {
            i &&
              this.logger.warn(
          ...
          if (null != i && "" !== i) {
            if (this.backend && this.backend.create) {
              ...
              if (l.length < 6)
                try {
                  let s;
                  (s = 5 === l.length ? l(e, t, i, n, a) : l(e, t, i, n)) &&
      ...
      class D extends o {
        ...
        init() {
          ...
          if (
            ...
            (o.logger = r),
              ...
              (o.interpolator = new P(this.options)),
              (o.utils = {
                hasLoadedNamespace: this.hasLoadedNamespace.bind(this),
              }),
              (o.backendConnector = new I(
              ...
              this.modules.languageDetector &&
                ((o.languageDetector = s(this.modules.languageDetector)),
          ...
          let s = function (e, t) {
            ...
            if ("object" != typeof t) {
              for (
                ...
                l[u - 2] = arguments[u];
              r = n.options.overloadTranslationOptionHandler([e, t].concat(l));
            } else r = { ...t };
            (r.lng = r.lng || s.lng),
              (r.lngs = r.lngs || s.lngs),
              (r.ns = r.ns || s.ns),
              (r.keyPrefix = r.keyPrefix || i || s.keyPrefix);
            let p = n.options.keySeparator || ".";
            return (
              (o =
                r.keyPrefix && Array.isArray(e)
                  ? e.map((e) => `${r.keyPrefix}${p}${e}`)
                  : r.keyPrefix
                  ? `${r.keyPrefix}${p}${e}`
                  : e),
              n.t(o, r)
        ...
        cloneInstance() {
          ...
          return (
            ...
            i &&
              ((s.store = new v(this.store.data, n)),
              (s.services.resourceStore = s.store)),
            (s.translator = new S(s.services, n)),
      ...
      let U = D.createInstance();
      U.createInstance = D.createInstance;
      let K = U.createInstance;
      U.dir,
        U.init,
        U.loadResources,
        U.reloadResources,
    ...
    99328: (e, t, i) => {
      ...
      function s(e) {
        var t = (function (e, t) {
          if ("object" !== (0, n.A)(e) || null === e) return e;
...
//# sourceMappingURL=61721-f76b9612a46c89fa.js.map
