  ...
  [82312],
  {
    8949: (e, t, n) => {
      ...
      var a = n(54568),
        s = n(50441);
      function r(e) {
        let { name: t, size: n = 16, className: r, ...E } = e;
        return (0, a.jsx)("svg", {
          height: n,
          width: n,
          className: (0, s.A)("fill-transparent", r),
          ...E,
          "aria-hidden": !0,
    ...
    11510: (e, t, n) => {
      ...
      let r = new a.Vy({
        ...
        prettyLogTimeZone: s.p8 ? "UTC" : "local",
        prettyErrorStackTemplate:
          "  • {{fileName}}	{{method}}\n	{{filePathWithLine}}",
        prettyErrorTemplate:
          "\n{{errorName}} {{errorMessage}}\nerror stack:\n{{errorStack}}",
        prettyLogTemplate: "{{hh}}:{{MM}}:{{ss}}:{{ms}} [{{logLevelName}}] ",
        stylePrettyLogs: !s.p8,
        prettyLogStyles: { name: "yellow", dateIsoStr: "blue" },
        type: s.p8 ? "json" : "pretty",
      });
    },
    13330: (e, t, n) => {
      n.d(t, { AppRouterI18nContext: () => r, AppRouterI18nProvider: () => E });
      var a = n(54568),
        s = n(7620);
      let r = (0, s.createContext)(null);
      function E(e) {
        let { children: t, translations: n, locale: E, ns: o } = e,
          l = (0, s.useMemo)(
            () => ({ translations: n, locale: E, ns: o }),
            [E, o]
          );
          ...
          let {
            ...
            S = o.createElement(
              p ? "a" : "button",
              {
                ...
                ref: t,
                className: (0, l.A)(
                  _({ color: s, size: r, loading: n, variant: d }),
                  e.className
                ),
                onClick: h
                  ? (e) => {
                    ...
                    (0, a.jsx)("div", {
                      ...
                      children: (0, a.jsxs)("svg", {
                        className: (0, l.A)(
                          ...
                          "primary" === s ? "text-inverted" : "text-emphasis"
                        ),
    ...
    26682: (e, t, n) => {
      ...
      let s = () => {
        var e, t;
        let n =
            null != (e = (0, a.useSearchParams)()) ? e : new URLSearchParams(),
          s = null != (t = (0, a.useParams)()) ? t : {},
        ...
        return (
          ...
          new a.ReadonlyURLSearchParams(r)
        );
      };
    },
    43328: (e, t, n) => {
      ...
      let i = function () {
          let e =
              arguments.length > 0 && void 0 !== arguments[0]
                ? arguments[0]
                : "common",
            t = (0, E.useAtomsContext)(),
            { i18n: n, t: a } = (0, r.Bd)(e),
            s = Object.keys(n).length > 0;
          return (null == t ? void 0 : t.clientId)
            ? { i18n: t.i18n, t: t.t, isLocaleReady: !0 }
            : { i18n: n, t: a, isLocaleReady: s };
        },
        d = new Map(),
        _ = () => {
          let e = (0, s.useContext)(o.AppRouterI18nContext),
            t = (0, s.useContext)(l.CustomI18nContext),
            n = i();
          if (e) {
            let { translations: n, locale: s, ns: r } = null != t ? t : e,
              E = "".concat(s, "-").concat(r);
            if (!d.has(E)) {
              let e = (0, a.Q_)();
              e.init({ lng: s, resources: { [s]: { [r]: n } } }),
                d.set(E, { t: e.getFixedT(s, r), isLocaleReady: !0, i18n: e });
            }
            return d.get(E);
          }
          return (
    ...
    50441: (e, t, n) => {
      ...
      function s() {
        for (var e = arguments.length, t = Array(e), n = 0; n < e; n++)
          t[n] = arguments[n];
        return (0, a.Q)(t.filter(Boolean).join(" "));
      }
    },
    66339: (e, t, n) => {
      n.d(t, {
      ...
      var a,
        ...
        i,
        d = n(40459);
      d.env.RAILWAY_STATIC_URL && d.env.RAILWAY_STATIC_URL,
        d.env.HEROKU_APP_NAME && d.env.HEROKU_APP_NAME,
        d.env.RENDER_EXTERNAL_URL && d.env.RENDER_EXTERNAL_URL;
      let _ = "production" === (d.env.CALCOM_ENV || "production");
      d.env.ORGANIZER_EMAIL_EXEMPT_DOMAINS;
      let c = d.env.NEXT_PUBLIC_SINGLE_ORG_SLUG,
        N = "https://app.cal.com",
        T = "https://cal.com",
        A = "Cal.com",
        I = "help@cal.com",
        ...
        u = "Calcom",
        m = "Cal.com";
      d.env.EMAIL_FROM_NAME;
      let R = new URL(N).hostname.endsWith(".vercel.app")
          ? N
          : "https://cal.com",
        L =
          N &&
          (new URL(N).hostname.endsWith("cal.com") ||
            new URL(N).hostname.endsWith("cal.dev") ||
            new URL(N).hostname.endsWith("cal.qa") ||
            new URL(N).hostname.endsWith("cal-staging.com") ||
            new URL(N).hostname.endsWith("cal.eu")),
        h =
          new URL(N).hostname.endsWith(".cal.dev") ||
          new URL(N).hostname.endsWith(".cal.qa") ||
          new URL(N).hostname.endsWith(".cal-staging.com")
        ...
        p = new URL(N).hostname,
        S = ![".cal.com", ".cal.dev", ".cal.eu", ".cal.qa"].some((e) =>
          p.endsWith(e)
        ),
        C = d.env.NEXT_PUBLIC_EMBED_LIB_URL || "".concat(N, "/embed/embed.js"),
        D = 1e3,
        v = 1440,
        b = 1,
        g = d.env.NEXT_PUBLIC_HOSTED_CAL_FEATURES || !S,
        M =
          parseInt(
            null != (E = d.env.NEXT_PUBLIC_QUERY_RESERVATION_INTERVAL_SECONDS)
              ? E
              : "",
            10
          ) || 30,
        f =
          parseInt(
            null != (o = d.env.NEXT_PUBLIC_QUERY_RESERVATION_STALE_TIME_SECONDS)
              ? o
              : "",
            10
          ) || 20,
        U =
          parseInt(
            null !=
              (l = d.env.NEXT_PUBLIC_QUERY_AVAILABLE_SLOTS_INTERVAL_SECONDS)
              ? l
              : "",
            10
          ) || 300,
        ...
        P = parseInt("0", 10) || 0,
        w = "/avatar.svg",
        G = "https://cal.com/roadmap",
        B = "https://cal.com/download",
        y = "https://go.cal.com/booking",
        V = "https://cal.com/docs",
        W = !!(d.env.STRIPE_CLIENT_ID && d.env.STRIPE_PRIVATE_KEY) && g,
        H = g,
        F = 50,
        j = 80,
        Y = "2",
        K = "1" === d.env.NEXT_PUBLIC_ENABLE_PROFILE_SWITCHER,
        k = JSON.parse("[".concat(d.env.ALLOWED_HOSTNAMES || "", "]")),
        X = JSON.parse("[".concat(d.env.RESERVED_SUBDOMAINS || "", "]"));
      parseInt("1"),
        parseFloat(
          d.env.NEXT_PUBLIC_ORGANIZATIONS_SELF_SERVE_PRICE_NEW || "37"
        ),
        d.env.E2E_TEST_MAILHOG_ENABLED;
      let z = "5.8.12";
      d.env.CALCOM_CREDENTIAL_SYNC_SECRET &&
        d.env.CALCOM_APP_CREDENTIAL_ENCRYPTION_KEY,
        d.env.CALCOM_CREDENTIAL_SYNC_SECRET,
        d.env.CALCOM_CREDENTIAL_SYNC_HEADER_NAME,
        d.env.CALCOM_CREDENTIAL_SYNC_ENDPOINT,
        d.env.CALCOM_SERVICE_ACCOUNT_ENCRYPTION_KEY;
      let q = "#292929",
        Q = "#fafafa",
        J = 40;
      L || d.env.NEXT_PUBLIC_IS_E2E;
      let Z = 100,
        $ = /(^\w+:|^)\/\//,
        ee = !!(null == (s = globalThis.window) || null == (a = s.Meticulous)
          ...
          : a.isRunningAsTest),
        et = parseInt(
          null != (i = d.env.NEXT_PUBLIC_BOOKER_NUMBER_OF_DAYS_TO_LOAD)
            ? i
            : "0",
          0
        ),
        ...
        er = !0,
        eE = 1;
      d.env.CALCOM_PRIVATE_API_ROUTE;
      let eo =
          d.env.NEXT_PUBLIC_WEBSITE_PRIVACY_POLICY_URL ||
          "https://cal.com/privacy",
        el = d.env.NEXT_PUBLIC_WEBSITE_TERMS_URL || "https://cal.com/terms";
      d.env.LINGO_DOT_DEV_API_KEY;
      let ei = 61,
        ed = _
          ? "".concat(N, "/sparkles-red.svg")
          : "https://app.cal.com/sparkles-red.svg",
        e_ = _
          ? "".concat(N, "/sparkles.svg")
          : "https://app.cal.com/sparkles.svg",
        ec = _
          ? "".concat(N, "/start-recording.svg")
          : "https://app.cal.com/start-recording.svg",
        eN = _
          ? "".concat(N, "/stop-recording.svg")
          : "https://app.cal.com/stop-recording.svg";
      null == (r = d.env.DIRECTORY_IDS_TO_LOG) || r.split(",");
      let eT = !!(!S && d.env.IFFY_API_KEY),
        eA = !0;
      d.env.CAL_VIDEO_MEETING_LINK_FOR_TESTING;
      let eI = !0;
      parseInt(d.env.DATABASE_CHUNK_SIZE || "25", 10);
      let eO = "default_group_id",
        eu = (() => {
          let e = "" !== "5".trim() ? Number("5") : NaN;
          return Number.isFinite(e) ? e : 5;
        })();
      d.env.RETELL_AI_TEST_MODE,
        (() => {
          if (d.env.RETELL_AI_TEST_EVENT_TYPE_MAP)
            try {
              return JSON.parse(d.env.RETELL_AI_TEST_EVENT_TYPE_MAP);
            } catch (e) {
              return (
                console.warn(
        ...
        d.env._CAL_INTERNAL_PAST_BOOKING_RESCHEDULE_CHANGE_TEAM_IDS;
    },
    72221: (e, t, n) => {
      n.d(t, { A: () => o, Tooltip: () => E });
      var a = n(54568),
        ...
        let {
          ...
          c = (0, a.jsx)(s.UC, {
            ...
            className: (0, r.A)(
              ...
              _.className && "".concat(_.className)
            ),
            side: d,
            align: "center",
            children: n,
          });
        return (0, a.jsxs)(s.bL, {
          delayDuration: i || 50,
          open: E,
          defaultOpen: o,
          onOpenChange: l,
          children: [
            (0, a.jsx)(s.l9, { asChild: !0, children: t }),
            (0, a.jsx)(s.ZL, { children: c }),
          ],
        });
      }
      let o = E;
    ...
    80835: (e, t, n) => {
      n.d(t, { O8: () => i, e6: () => l, io: () => o });
      var a = n(66339),
        s = n(11510),
        r = n(40459);
      let E = s.A.getSubLogger({ prefix: ["orgDomains.ts"] });
      function o(e) {
        let { hostname: t, fallback: n, forcedSlug: s } = e,
          o = (function (e, t) {
            if (t) {
              ...
              E.debug("Ignoring forcedSlug in non-test mode", {
                forcedSlug: t,
              });
            }
            if (a.w2)
              return (
                E.debug(
                  ...
                  { SINGLE_ORG_SLUG: a.w2 }
                ),
                a.w2
              );
            if (!e.includes("."))
              return (
                E.warn('Org support not enabled for hostname without "."', {
                  hostname: e,
                }),
                null
              );
            ...
            if (!n)
              return (
                E.warn("Match of WEBAPP_URL with ALLOWED_HOSTNAMES failed", {
                  WEBAPP_URL: a.YW,
                  ALLOWED_HOSTNAMES: a.Um,
                }),
                null
              );
            let s = e.replace(n ? ".".concat(n) : "", "");
            return -1 === s.indexOf(".")
              ? s
              : (E.warn(
          ...
          l = null !== o && !a.N2.includes(o);
        if (l || !n)
          return { currentOrgDomain: l ? o : null, isValidOrgDomain: l };
        let i = !a.N2.includes(n);
        return { currentOrgDomain: i ? n : null, isValidOrgDomain: i };
      }
      function l() {
        var e;
        if (!a.p8 && r.env.LOCAL_TESTING_DOMAIN_VERCEL)
          return r.env.LOCAL_TESTING_DOMAIN_VERCEL;
        let t =
          null == (e = a.YW.replace("https://", ""))
            ? void 0
      ...
      function i(e) {
        ...
        return e
          ? ""
              .concat(t.protocol ? "".concat(new URL(a.CY).protocol, "//") : "")
              .concat(e, ".")
              .concat(l())
          : t.protocol
          ? a.CY
          : a.CY.replace("https://", "").replace("http://", "");
      }
    },
    82441: (e, t, n) => {
      n.d(t, { e: () => N });
      ...
      function N(e) {
        let {
          ...
          A = c({ size: n, shape: e.shape }),
          I = (0, d.A)("aspect-square rounded-full", A),
          O = (0, a.jsx)(s.bL, {
            ...
            children: (0, a.jsxs)(a.Fragment, {
              children: [
                (0, a.jsx)(s._V, {
                  src: null != t ? t : void 0,
                  alt: E,
                  className: (0, d.A)("aspect-square", A),
                }),
                (0, a.jsx)(s.H4, {
                  delayMs: 600,
                  asChild: e.asChild,
                  ...
                  children: (0, a.jsx)(a.Fragment, {
                    children: e.fallback
                      ? e.fallback
                      : (0, a.jsx)("img", { src: i.pD, alt: E, className: I }),
                  }),
                }),
                T,
              ],
        ...
        return (
          N &&
            (O = (0, a.jsx)(l(), {
              "data-testid": "avatar-href",
              href: N,
              children: O,
            })),
          o
            ? (0, a.jsx)(r.Kq, {
                children: (0, a.jsx)(_.A, { content: o, children: O }),
              })
    ...
    94355: (e, t, n) => {
      n.r(t),
        n.d(t, { CustomI18nContext: () => r, CustomI18nProvider: () => E });
      var a = n(54568),
        s = n(7620);
      let r = (0, s.createContext)(null);
      function E(e) {
    ...
    96968: (e, t, n) => {
      ...
      let a = {
        ...
        r = { API_V1: "API_V1", API_V2: "API_V2", WEBAPP: "WEBAPP" },
        E = { CAL: "CAL", GOOGLE: "GOOGLE", SAML: "SAML" },
        o = { USER: "USER", ADMIN: "ADMIN" },
        l = { MEMBER: "MEMBER", ADMIN: "ADMIN", OWNER: "OWNER" },
        i = {
          CANCELLED: "CANCELLED",
          ACCEPTED: "ACCEPTED",
          REJECTED: "REJECTED",
        ...
        A = { DAY: "DAY", HOUR: "HOUR", MINUTE: "MINUTE" },
        I = {
          REMINDER: "REMINDER",
          CUSTOM: "CUSTOM",
          CANCELLED: "CANCELLED",
        ...
        O = { MONTH: "MONTH", DAY: "DAY" },
        u = { CREATED_AT: "CREATED_AT", START_TIME: "START_TIME" },
        m = {
          LOCKED: "LOCKED",
          UNLOCKED: "UNLOCKED",
        ...
        h = { DESCRIPTION: "DESCRIPTION", TITLE: "TITLE" },
        p = { EMAIL: "EMAIL", DOMAIN: "DOMAIN", USERNAME: "USERNAME" },
        S = {
          SPAM: "SPAM",
          DONT_KNOW_PERSON: "DONT_KNOW_PERSON",
          OTHER: "OTHER",
        },
        C = { MONTHLY: "MONTHLY", ANNUALLY: "ANNUALLY" },
        D = { SALESFORCE: "SALESFORCE" },
        v = {
          ACTIVE: "ACTIVE",
          PAST_DUE: "PAST_DUE",
          CANCELLED: "CANCELLED",
...
//# sourceMappingURL=82312-bac94d54854e89e6.js.map
