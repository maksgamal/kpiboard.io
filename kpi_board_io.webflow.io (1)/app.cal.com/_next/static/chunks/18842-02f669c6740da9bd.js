...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [18842],
  {
    18842: (r, e, o) => {
      ...
      function b(r) {
        return y(r) || d.has(r) || c.test(r) || m(r);
      }
      function m(r) {
        return I(r, "length", M);
      }
      ...
      function w(r) {
        return r.endsWith("%") && y(r.slice(0, -1));
      }
      function k(r) {
        return S(r) || I(r, "number", S);
      }
      function z(r) {
        return a.test(r);
      }
      ...
      var O = (function () {
        for (var r, e, o, s = arguments.length, a = Array(s), c = 0; c < s; c++)
          a[c] = arguments[c];
        var d = function (i) {
          var l = a[0];
          return (
            (e = (r = (function (r) {
              var e, o, i, l, s, a, c, d, u, p, f, b, m, g;
              return {
                cache: (function (r) {
                  if (r < 1)
                ...
                splitModifiers:
                  ...
                  function (r) {
                    ...
                    var u = 0 === n.length ? r : r.substring(a),
                      p = u.startsWith("!"),
                      f = p ? u.substring(1) : u;
                    return {
                      modifiers: n,
                ...
                (d =
                  void 0 === (c = r.conflictingClassGroupModifiers) ? {} : c),
                {
        ...
        return {
          ...
          classGroups: {
            ...
            "col-start-end": [{ col: ["auto", { span: [k] }, z] }],
            ...
            "underline-offset": [{ "underline-offset": ["auto", b] }],
            ...
            "outline-offset": [{ "outline-offset": [b] }],
            "outline-w": [{ outline: [b] }],
...
//# sourceMappingURL=18842-02f669c6740da9bd.js.map
