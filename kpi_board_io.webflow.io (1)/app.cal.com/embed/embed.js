!(function () {
  const fe = ({
      ...
      buttonColor: t,
      buttonTextColor: a,
    }) => `<button class="z-[999999999999] hidden fixed md:bottom-6 bottom-4 md:right-10 right-4 md:left-10 left-4 ${e.join(
      " "
...
<div id="button" class="font-semibold leading-5 antialiased">${o}</div>
  ...
  class z extends HTMLElement {
    constructor() {
      ...
      const e = this.dataset,
        ...
        r = e.buttonColor,
        i = e.buttonTextColor,
        n = `<style>${window.Cal.__css}</style> ${fe({
          buttonText: t,
          buttonClasses: [z.updatedClassString(a, "")],
          buttonColor: r,
          buttonTextColor: i,
        })}`;
    ...
    attributeChangedCallback(e, t, a) {
      var l, c, d;
      const r =
          (l = this.shadowRoot) == null ? void 0 : l.querySelector("#button"),
        i = (c = this.shadowRoot) == null ? void 0 : c.querySelector("button"),
        n =
          (d = this.shadowRoot) == null
            ? void 0
            : d.querySelector("#button-icon");
      ...
      if (e === "data-button-text") r.textContent = a;
      else if (e === "data-hide-button-icon")
        n.style.display = a == "true" ? "none" : "block";
      else if (e === "data-button-position")
        i.className = z.updatedClassString(a, i.className);
        ...
        const h = a == "true";
        h && (this.buttonWrapperStyleDisplay = i.style.display),
          (i.style.display = h ? "none" : this.buttonWrapperStyleDisplay);
  ...
  const ye = 60 * 1e3,
    ve = 15 * 60 * 1e3,
    xe = 1 * 60 * 1e3,
    J = "cal-element-embed-light",
    B = "cal-element-embed-dark";
  function Z() {
  ...
  function q({ layout: o }) {
    if (ke("(max-width: 768px)")) return "mobile";
    const t = "month_view";
    return o === "mobile" ? t : o ?? t;
  }
  function Se() {
  ...
  function Ee(o) {
    te().addEventListener("change", o);
  }
  function Te(o) {
    var e;
    (e = te()) == null || e.removeEventListener("change", o);
  }
  class ae extends HTMLElement {
    constructor(e) {
      super(),
        (this.skeletonContainerHeightTimer = null),
        {}.INTEGRATION_TEST_MODE && Object.assign(this.dataset, e.dataset),
        ...
        (this.boundPrefersDarkThemeChangedHandler =
          this.prefersDarkThemeChangedHandler.bind(this));
    }
    ...
    getLayout() {
      return q({ layout: this.dataset.layout ?? null });
    }
    ...
    ensureContainerTakesSkeletonHeightWhenVisible() {
      const e = this.getSkeletonElement(),
        ...
        a = this.isModal,
        r = parseFloat(getComputedStyle(e).height);
      if (a) {
        const n = t;
        if (r) (n.style.maxHeight = `${Z()}px`), (n.style.height = `${r}px`);
        else {
    ...
    toggleLoader(e) {
      const t = this.getSkeletonElement(),
        ...
        r = this.getSkeletonContainerElement();
    ...
    resizeHandler() {
      const e = q({ layout: this.layout ?? null });
      if (
        e === this.layout ||
        ((this.layout = e), !this.isSkeletonLoaderVisible())
      )
        return;
      const {
          skeletonContent: t,
      ...
      i.setAttribute("style", a), n.setAttribute("style", r), (n.innerHTML = t);
    }
    setTheme(e) {
      const t = [B, J],
        a = Ce({ theme: e });
  ...
  function oe(o) {
    ...
    for (const [t, a] of o)
      if (e.hasOwnProperty(t)) {
        let r = e[t];
        Array.isArray(r) || (r = [r]), r.push(a), (e[t] = r);
      } else e[t] = a;
    return e;
  }
  function Le() {
  ...
  function Me(o) {
    return (
      ...
      o.slice(1).replace(/[A-Z]/g, (e) => `-${e.toLowerCase()}`)
    );
  }
  function Pe(o) {
    return o
  ...
  function j(o) {
    return Object.entries(o)
      .filter((e) => !!e[1])
      .map(([e, t]) => `data-${Me(e)}="${Pe(t)}"`)
      .join(" ");
  }
  function N(o) {
    return new URL(o, "http://baseUrl.example").pathname === "/router";
  }
  function Re({ bookingLinkPath1: o, bookingLinkPath2: e }) {
    return o.replace(/^\/team\//, "/") === e.replace(/^\/team\//, "/");
  }
  function Ae({ config: o, isHeadlessRouterPath: e, backgroundSlotsFetch: t }) {
    return (
      e && (o["cal.queueFormResponse"] = "true"),
      t || (o["cal.skipSlotsFetch"] = "true"),
      { ...o, prerender: "true" }
    );
  }
  const ze = `@keyframes loader{0%{transform:rotate(0)}25%{transform:rotate(180deg)}50%{transform:rotate(180deg)}75%{transform:rotate(360deg)}to{transform:rotate(360deg)}}@keyframes loader-inner{0%{height:0%}25%{height:0%}50%{height:100%}75%{height:100%}to{height:0%}}.loader-inner{vertical-align:top;display:inline-block;width:100%;animation:loader-inner 2s infinite ease-in}.loader{display:block;width:30px;height:30px;position:relative;border-width:4px;border-style:solid;animation:loader 2s infinite ease}.loader.modal-loader{margin:60px auto}
`,
    U = () => `
          ...
          <div>
            <div class="mb-1 flex items-center justify-between text-xl">
              <span class="text-default w-1/2 text-base">
                <time datetime="${`${t.getFullYear()}-${String(
                  t.getMonth() + 1
                ).padStart(2, "0")}`}" data-testid="selected-month-label">
...
`,
    ie = ({ layout: o = "month_view", pageType: e }) => {
      const t = Q({ layout: o });
      return e &&
        (e === "user.event.booking.slots" || e === "team.event.booking.slots")
        ? Q({ layout: o })
        : t;
    },
    Ie = ({ layout: o = "month_view", pageType: e }) => {
...
`;
    ...
    ne = ({ layout: o, pageType: e }) => {
      const r =
        ...
        i = "width:100%;";
      return {
        skeletonContent: ie({ layout: o, pageType: e }),
        skeletonContainerStyle: i,
        skeletonStyle: r,
      };
    };
  class _e extends ae {
    ...
    attributeChangedCallback(e, t, a) {
      this.assertHasShadowRoot();
      const r = this.shadowRoot.querySelector("#error"),
    ...
    constructor() {
      super({ isModal: !1, getSkeletonData: ne }),
        this.attachShadow({ mode: "open" }),
        this.assertHasShadowRoot(),
        (this.shadowRoot.innerHTML = `<style>${
          window.Cal.__css
        }</style><style>${ze}</style>${Ie({
          layout: this.layout,
          pageType: this.getPageType() ?? null,
        })}`);
    }
  }
  const $e = `@keyframes loader{0%{transform:rotate(0)}25%{transform:rotate(180deg)}50%{transform:rotate(180deg)}75%{transform:rotate(360deg)}to{transform:rotate(360deg)}}@keyframes loader-inner{0%{height:0%}25%{height:0%}50%{height:100%}75%{height:100%}to{height:0%}}.loader-inner{vertical-align:top;display:inline-block;width:100%;animation:loader-inner 2s infinite ease-in}.loader{display:block;width:30px;height:30px;position:relative;border-width:4px;border-style:solid;animation:loader 2s infinite ease}.loader.modal-loader{margin:60px auto}
`;
  function Fe() {
    return `
  <style>
  ...
  const Be = ({ layout: o = "month_view", pageType: e }) => {
      const {
        skeletonContent: t,
        skeletonContainerStyle: a,
        skeletonStyle: r,
      } = se({ layout: o, pageType: e });
      return `
${Fe()}
<div class="my-backdrop">
  ...
  class I extends ae {
    ...
    show(e) {
      this.assertHasShadowRoot(),
        ...
        e || (document.body.style.overflow = I.htmlOverflow);
    }
    open() {
    ...
    onStateFailedOrMessage() {
      this.toggleLoader(!1),
        this.toggleMessageElement(!0),
        this.collapseIframe();
      const e = this.dataset.message,
        a =
          (this.dataset.errorCode
            ? re({ errorCode: this.dataset.errorCode, errorMessage: e })
            : null) || e;
    ...
    constructor() {
      super({ isModal: !0, getSkeletonData: se });
      const e = `<style>${window.Cal.__css}</style><style>${$e}</style>${Be({
        layout: this.getLayout(),
        pageType: this.getPageType() ?? null,
      })}`;
      this.attachShadow({ mode: "open" }),
        (I.htmlOverflow = document.body.style.overflow),
  ...
  const He = () => {
      const o = ["cal-floating-button", "cal-modal-box", "cal-inline"];
      try {
        const e = `
    ${o.join(",")} {
    /* Spacing Scale */
  ...
  `,
        ...
        console.error(
          "Error adding app css vars - Report this issue to support",
          e
        );
      }
    },
    De = `.cal-embed{border:0px;min-height:300px;margin:0 auto;width:100%;display:block!important;color-scheme:unset!important}
`;
  function qe(o) {
    ...
    for (; e && e !== document.documentElement; ) {
      const t = window.getComputedStyle(e),
        ...
        i = ["auto", "scroll"].includes(a) || ["auto", "scroll"].includes(r),
  ...
  const Oe = (o) => (e) => {
    if (!o.inlineEl) {
      console.warn(
        "scrollBy event received but ignored as it isn't an inline embed"
      );
      return;
    }
    const t = e.detail.data.distance;
    o.scrollByDistance(t);
  };
  function V(o, e) {
    const t = new window.CustomEvent(o, { detail: e });
  ...
  class le {
    ...
    fire(e, t) {
      const a = this.getFullActionName(e),
        r = { type: e, namespace: this.namespace, fullType: a, data: t };
      V(a, r), V(this.getFullActionName("*"), r);
    }
    on(e, t) {
      const a = this.getFullActionName(e);
...
`,
    Ne = "https://app.cal.com";
  He();
  customElements.define("cal-modal-box", I);
  customElements.define("cal-floating-button", z);
  customElements.define("cal-inline", _e);
  const u = window.Cal;
  if (!u || !u.q) throw new Error("Cal is not defined. This shouldn't happen");
  Ve();
  document.head.appendChild(document.createElement("style")).innerHTML = De;
  function A(o, e) {
    function t(r, i) {
    ...
    if (e.required && a(o)) throw new Error("Argument is required");
    for (const [r, i] of Object.entries(e.props || {})) {
      if (i.required && a(o[r])) throw new Error(`"${r}" is required`);
      let n = !0;
      if (
        (i.type &&
          !a(o[r]) &&
  ...
  function ce(o) {
    const e = getComputedStyle(o).colorScheme;
    return e === "dark" || e === "light" ? e : null;
  }
  function W(o, e) {
    if (!o["ui.color-scheme"]) {
      const t = ce(e);
      t && (o["ui.color-scheme"] = t);
    }
    return o;
  }
  const Ue = (o, e) =>
  ...
  class f {
    constructor(e, t) {
      (this.iframeDoQueue = []),
        ...
        (this.__config = { calOrigin: Ne }),
        (this.api = new ue(this)),
        (this.namespace = e),
        (this.actionManager = new le(e)),
        (f.actionsManagers = f.actionsManagers || {}),
        (f.actionsManagers[e] = this.actionManager),
        this.processQueue(t),
        this.actionManager.on("__dimensionChanged", (a) => {
          ...
          r.iframeHeight && (i.style.height = r.iframeHeight + n),
            this.modalBox && (i.style.maxHeight = `${Z()}px`);
        }),
        this.actionManager.on("__iframeReady", (a) => {
          (this.iframeReady = !0),
            this.iframe &&
              !a.detail.data.isPrerendering &&
              (this.iframe.style.visibility = ""),
            this.doInIframe({ method: "parentKnowsIframeReady" }),
            this.iframeDoQueue.forEach((r) => {
              this.doInIframe(r);
            });
        }),
        this.actionManager.on("__routeChanged", () => {
          if (!this.inlineEl) return;
          const { top: a, height: r } = this.inlineEl.getBoundingClientRect();
          a < 0 &&
            Math.abs(a / r) >= 0.25 &&
            this.inlineEl.scrollIntoView({ behavior: "smooth" });
        }),
        this.actionManager.on("__scrollByDistance", Oe(this)),
        ...
        this.actionManager.on("linkFailed", (a) => {
          ...
          this.iframe &&
            (this.isPrerendering ||
              ((i = this.inlineEl) == null ||
                i.setAttribute("data-error-code", a.detail.data.code),
              (n = this.modalBox) == null ||
                n.setAttribute("data-error-code", a.detail.data.code),
              (l = this.inlineEl) == null ||
                l.setAttribute("loading", "failed"),
              (c = this.modalBox) == null ||
                c.setAttribute("state", "failed")));
        });
    }
    ...
    processInstruction(e) {
      ...
      const [a, ...r] = t;
      this.api[a] || X(`Instruction ${a} not FOUND`);
      try {
        this.api[a](...r);
      } catch (i) {
    ...
    createIframe({ calLink: e, config: t = {}, calOrigin: a }) {
      ...
      return (
        ...
        (r.title = "Book a call"),
        this.loadInIframe({ calLink: e, config: t, calOrigin: a, iframe: r }),
        r
      );
    }
    loadInIframe({ calLink: e, config: t = {}, calOrigin: a, iframe: r }) {
      b("Loading in iframe", e, "with config", JSON.stringify(t)),
        (r.dataset.calLink = e);
      const i = this.getCalConfig(),
        { iframeAttrs: n, ...l } = t;
      n && n.id && r.setAttribute("id", n.id),
        r.setAttribute("allow", "payment");
      const c = this.buildFilteredQueryParams(l),
        d = (a || i.calOrigin || "").replace(
          "https://cal.com",
          "https://app.cal.com"
        ),
        h = new URL(`${d}/${e}`);
      h.pathname.endsWith("embed") || (h.pathname = `${h.pathname}/embed`),
        h.searchParams.set("embed", this.namespace);
      const s = this.getQueryParamsFromPage();
      (i.debug || s["cal.embed.logging"] === "1") &&
        h.searchParams.set("debug", "true"),
        (r.style.visibility = "hidden"),
        i.uiDebug && (r.style.border = "1px solid green");
      for (const [m, p] of c) h.searchParams.append(m, p);
      return (
        (this.iframeReady = !1),
        r.src === h.toString() &&
          h.searchParams.append("__cal.reloadTs", Date.now().toString()),
        (r.src = h.toString()),
        r
      );
    }
    ...
    filterParams(e) {
      return Object.fromEntries(Object.entries(e).filter(([t, a]) => !Ue(t)));
    }
    getQueryParamsFromPage() {
      const e = Ke();
      return this.filterParams(e);
    }
    buildFilteredQueryParams(e) {
      var i;
      const a = {
          ...((i = u.config) != null && i.forwardQueryParams
            ? this.getQueryParamsFromPage()
            : {}),
          ...e,
        },
      ...
      for (const [n, l] of Object.entries(a))
        l !== void 0 &&
          (l instanceof Array ? l.forEach((c) => r.append(n, c)) : r.set(n, l));
      return r;
    }
    getNextActionForModal({ modal: e, pathWithQueryToLoad: t, stateData: a }) {
      const {
        ...
        h = this.getCalConfig(),
        s = this.getLastLoadedLinkInframe(),
        m = (s == null ? void 0 : s.pathname) ?? null,
        p = new URL(t, h.calOrigin),
        y = document.querySelector(`cal-modal-box[uid="${e.uid}"]`),
        v = p.pathname,
        x = m && Re({ bookingLinkPath1: m, bookingLinkPath2: v }),
        w = s == null ? void 0 : s.searchParams.toString(),
        k = p.searchParams.toString(),
        g = w === k,
        S = i && ge({ embedConfig1: i, embedConfig2: r }),
        E = y && y.getAttribute("state") === "failed",
        T = l ? c - l : 0,
        H = l
          ? T > ((d == null ? void 0 : d.iframeForceReloadThresholdMs) ?? ve)
          : !1,
        _ = l ? T > ((d == null ? void 0 : d.slotsStaleTimeMs) ?? ye) : !1,
        pe = !x || E || H,
        D = (() =>
          pe
            ? "fullReload"
            : d != null && d.backgroundSlotsFetch && !_
      ...
      return (
        b(
          "Next Modal Action:",
          { actionToTake: D, prerenderOptions: d },
          {
            path: { isSame: x, urlToLoadPath: v, lastLoadedPathInIframe: m },
            config: { isSame: S, previousEmbedConfig: i, embedConfig: r },
            queryParams: {
              isSame: g,
              lastLoadedUrlInIframeObjectSearchParams: w,
              urlToLoadObjectSearchParams: k,
            },
            areSlotsStale: _,
            crossedReloadThreshold: H,
            isInFailedState: E,
            isConnectionInitiated: n,
          }
        ),
      ...
      function ge({ embedConfig1: M, embedConfig2: $ }) {
        return Object.keys(M).length !== Object.keys($).length
          ? !1
          : Object.keys(M).every((P) => {
              if (typeof M[P] != typeof $[P]) return !1;
              const L = M[P],
                R = $[P];
              return L instanceof Array && R instanceof Array
                ? L.length === R.length && L.every((be) => R.includes(be))
                : typeof L == "string"
                ? L === R
                : !0;
            });
    ...
    getLastLoadedLinkInframe() {
      if (!this.iframe || !this.iframe.dataset.calLink) return null;
      const e = this.iframe.dataset.calLink;
      if (!e) return null;
      const t = new URL(e, new URL(this.iframe.src).origin);
      return new URL(`${t.pathname}${t.search}`, t.origin);
    }
    recordUpdatedParamsForIframe(e) {
      const t = this.getLastLoadedLinkInframe();
      if (!t || !this.iframe) return;
      const a = new URL(t.toString());
      for (const [r, i] of Object.entries(e)) a.searchParams.set(r, i);
      this.iframe.dataset.calLink = `${a.pathname.replace(/^\//, "")}${
        a.search
      }`;
    }
    canPrerenderLink({
      ...
      const r = this.getLastLoadedLinkInframe();
      if ((r == null ? void 0 : r.toString()) === new URL(e, t).toString())
        return i()
          ? (b("Threshold crossed, allowing repeat prerender"), !0)
          : (b("Threshold not crossed, preventing repeat prerender"), !1);
      return !0;
      function i() {
        return a ? Date.now() - a >= xe : !1;
      }
    }
    prepareForPrerender({
      calLink: e,
      ...
      if (
        ...
        return null;
      this.modalBox &&
        (b("Destroying previous prerendered modalbox"), this.modalBox.remove());
      const n = !!i,
        l = typeof r.backgroundSlotsFetch > "u" ? n : r.backgroundSlotsFetch,
        c = { ...r, backgroundSlotsFetch: l };
      return (
    ...
    connect({ config: e, params: t }) {
      this.recordUpdatedParamsForIframe(t),
  ...
  const de = class he {
    ...
    init(e, t = {}) {
      let a = "";
      if (
        (typeof e != "string" ? (t = e || {}) : (a = e),
        a !== this.cal.namespace)
      )
        return;
      he.initializedNamespaces.push(this.cal.namespace);
      const { calOrigin: r, origin: i, ...n } = t;
      (this.cal.__config.calOrigin = r || i || this.cal.__config.calOrigin),
        (this.cal.__config = { ...this.cal.__config, ...n });
    }
    initNamespace(e) {
      u.ns[e].instance = u.ns[e].instance || new f(e, u.ns[e].q);
    }
    inline({ calLink: e, elementOrSelector: t, config: a }) {
      ...
      if (
        ((a = a || {}),
        typeof a.iframeAttrs == "string" || a.iframeAttrs instanceof Array)
      )
      ...
      const i = this.cal.getCalConfig(),
        n = this.cal.createIframe({
          calLink: e,
          config: W(f.ensureGuestKey(a), r),
          calOrigin: i.calOrigin,
        });
      (n.style.height = "100%"),
        (n.style.width = "100%"),
        r.classList.add("cal-inline-container");
    ...
    floatingButton({
      ...
      let h = null;
      r != null && r.id && (h = document.getElementById(r.id));
      let s;
      h
        ? (s = h)
    ...
    async modal({
      ...
      const d = new URL(e, a),
        h = d ? N(d.toString()) : !1,
        { embedConfig: s, embedRenderStartTime: m } =
          this.cal.getPreviousModalRenderStartVariables();
      let p;
      const y = W(f.ensureGuestKey({ ...t, embedType: "modal" }), l);
      let v;
      if (n) {
        const T = this.cal.prepareForPrerender({
          calLink: e,
          calOrigin: a,
          previousEmbedRenderStartTime: m,
          prerenderOptions: i,
          isHeadlessRouterPath: h,
        });
        if (!T)
          return (
            b(`Prevented unnecessary repeat prerender for ${e}`),
            { status: "prerender-prevented" }
          );
        (v = T.enrichedPrerenderOptions),
          (p = Ae({
            config: y,
            isHeadlessRouterPath: h,
            backgroundSlotsFetch: !!(
              (E = this.prerenderOptions) != null && E.backgroundSlotsFetch
            ),
          }));
      } else (this.cal.isPrerendering = !1), (p = y);
      const w = this.modalUid || this.prerenderedModalUid || String(Date.now()),
        k = !!(this.modalUid && this.prerenderedModalUid),
        g = Date.now(),
        S = {
          embedConfig: p,
          previousEmbedConfig: s,
          embedRenderStartTime: g,
          previousEmbedRenderStartTime: m,
          isConnectionInitiated: k,
          prerenderOptions: v ?? this.prerenderOptions ?? null,
        };
      return (
    ...
    async __modal({
      ...
      const c = new URL(t, r),
        d = c ? N(c.toString()) : !1,
        h = document.querySelector(`cal-modal-box[uid="${e}"]`);
      if (h && this.cal.iframe) {
        b(`Trying to reuse modal ${e}`);
        const w = this.cal.getLastLoadedLinkInframe(),
          k =
            (x = w == null ? void 0 : w.pathname) == null
              ? void 0
              : x.includes("/router");
        if (d && !k)
          throw new Error(
        ...
        {
          const g = this.cal.getNextActionForModal({
            modal: { uid: e },
            pathWithQueryToLoad: `${c.pathname}${c.search}`,
            stateData: n,
          });
          if (g === "noAction") {
            if (i) return;
            b(`Reopening modal without any other action needed ${e}`),
              h.setAttribute("state", "reopened");
            return;
          }
          if (
            (b("Attempting to load/connect regular booking link"),
            h.setAttribute("state", "loading"),
            g === "fullReload")
          )
            b("Initiating full page load"),
          ...
          else if (g === "connect" || g === "connect-no-slots-fetch") {
            const S = oe(c.searchParams.entries());
            this.cal.connect({
              config: {
                ...a,
                ...(g === "connect-no-slots-fetch"
      ...
      b(`Creating new modal ${e}`), i && (this.prerenderedModalUid = e);
      let s = null;
      s || (s = this.cal.createIframe({ calLink: t, config: a, calOrigin: r })),
        (s.style.borderRadius = "8px"),
        (s.style.height = "100%"),
        (s.style.width = "100%");
      const m = document.createElement("template"),
        p = C(a, "cal.embed.pageType"),
        y = C(a, "theme"),
        v = C(a, "layout");
      return (
        (m.innerHTML = `<cal-modal-box 
      ${j({ pageType: p, theme: y, layout: v })}
      uid="${e}">
    </cal-modal-box>`),
        (this.cal.modalBox = m.content.children[0]),
    ...
    preload({
      ...
      if ((l && (n = u.ns[l]), !n))
        throw new Error(`Namespace ${l} isn't defined`);
      const c = this.cal.getCalConfig(),
        { prerenderIframe: d, ...h } = a;
      let s = d;
      if ((t && s === void 0 && (s = !0), !t && s))
    ...
    ui(e) {
      A(e, {
        required: !0,
        props: {
          theme: { required: !1, type: "string" },
          styles: { required: !1, type: Object },
        },
      }),
        this.cal.doInIframe({ method: "ui", arg: e });
    }
  };
  de.initializedNamespaces = [];
  let ue = de;
  function Ke() {
  ...
  const me = "";
  u.instance = new f(me, u.q);
  for (const [o, e] of Object.entries(u.ns))
    e.instance = e.instance ?? new f(o, e.q);
  window.addEventListener("message", (o) => {
    const e = o.data,
      t = e.fullType,
      a = le.parseAction(t);
    if (!a) return;
    const r = f.actionsManagers[a.ns];
    if (
      ((u.__logQueue = u.__logQueue || []),
      u.__logQueue.push({ ...a, data: e.data }),
      !r)
    )
      throw new Error(`Unhandled Action ${a}`);
    r.fire(a.type, e.data);
  });
  document.addEventListener("click", (o) => {
    var h;
    const e = o.target,
      t = d(e),
      a = (h = t == null ? void 0 : t.dataset) == null ? void 0 : h.calLink;
    if (!a) return;
    const r = t.dataset.calNamespace,
    ...
    function d(s) {
      ...
      return !(s instanceof HTMLElement) ||
        (s != null && s.dataset.calLink
          ? (m = s)
          : (m = Array.from(document.querySelectorAll("[data-cal-link]")).find(
              (p) => p.contains(s)
            )),
  ...
  (function () {
    setInterval(() => {
      const e = ce(document.body);
      e &&
        e !== Y &&
        ((Y = e),
        ue.initializedNamespaces.forEach((t) => {
          Qe(t)("ui", { colorScheme: e });
        }));
    }, 50);
  })();
  function Qe(o) {
    let e;
    return o === me ? (e = u) : (e = u.ns[o]), e;
  }
  function G({ config: o, calLink: e }) {
    const t = document.body.appendChild(document.createElement("iframe")),
      a = new URL(`${o.calOrigin}/${e}`);
  ...
  function Ve() {
    (u.fingerprint = "85fe406"),
      (u.version = "1.5.3"),
      (u.__css = je),
      u.config || (u.config = {}),
      (u.config.forwardQueryParams = u.config.forwardQueryParams ?? !1);
  }
  function b(...o) {
    const e = location.search;
    (u.__logQueue = u.__logQueue || []),
      u.__logQueue.push(o),
      (e.includes("cal.embed.logging=1") ||
