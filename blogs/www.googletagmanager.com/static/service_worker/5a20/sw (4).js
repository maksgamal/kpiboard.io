...
var ea = function (a, b, c, d) {
  ...
  fa = class {
    ...
    encrypt(a, b, c) {
      const d = this;
      return h(function* () {
        if (a.length !== 12) throw new u("IV must be 12 bytes");
...
var za = class {
  ...
  seal({ key: a, nonce: b, M: c, C: d }) {
    ...
    return h(function* () {
      ...
      return yield (yield G({ key: a, o: !1 })).encrypt(b, c, d);
    });
  }
  open({ key: a, nonce: b, H: c, C: d }) {
    ...
    return h(function* () {
      if (a.length !== e.B)
        throw new u("Unexpected key length: " + a.length.toString());
      return ea(yield G({ key: a, o: !1 }), b, c, d);
    });
  }
};
var Aa = class {};
...
var Ea = function (a, b, c) {
  ...
  V = function (a, { l: b, m: c, j: d, salt: e }) {
    return h(function* () {
      return yield Ea(a, P({ m: c, l: b, j: d }), e);
    });
  },
  Fa = function (a, b, c, d) {
    return h(function* () {
  ...
  Ga = function (a, { F: b, info: c, u: d, j: e, length: f }) {
    return h(function* () {
      return yield Fa(a, b, wa({ u: d, info: c, j: e, length: f }), f);
    });
  },
  Ha = function (a, { l: b, m: c, info: d, u: e, j: f, length: g, salt: k }) {
    return h(function* () {
      const n = yield Ea(a, P({ m: c, l: b, j: f }), k);
      return yield Fa(a, n, wa({ u: e, info: d, j: f, length: g }), g);
    });
  },
  U = function (a) {
    switch (a.v) {
...
function Ka(a, b, c, d, e, f) {
  return h(function* () {
    ...
    const n = va({ K: La(c), J: k, G: g }),
      q = V(d, { l: new Uint8Array(0), m: "psk_id_hash", j: n }),
      r = yield V(d, { l: f, m: "info_hash", j: n }),
      E = yield q,
      B = A(la, E, r),
      J = yield V(d, { l: new Uint8Array(0), m: "secret", j: n, salt: b }),
      z = Ga(d, { F: J, info: B, u: "key", j: n, length: e.B }),
      m = yield Ga(d, { F: J, info: B, u: "base_nonce", j: n, length: 12 }),
      t = yield z;
  ...
  ib = function (a, b) {
    return () => {
      b.fallback_url &&
        ...
        gb(a, { [b.fallback_url_method]: [b.fallback_url], options: {} });
    };
  },
  jb = class {
    constructor(a) {
  ...
  nb = function (a, b, c) {
    return h(function* () {
      ...
      try {
        ...
        return (
          c == null || c(),
          { failureType: 9, command: 0, data: `Fetch failed: ${m}` }
        );
      }
    });
  },
  ...
  lb = function (a, b, c, d) {
    return d
      .then(
        ...
        () => [`ec.${Za(15)}`, "&_es=15"].join("")
      )
      .catch(() => [`ec.${Za(16)}`, "&_es=16"].join(""));
  },
  sb = class {
    constructor(a) {
      this.g = a;
